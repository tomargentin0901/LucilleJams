...
def get_playlist_embeddings(
    ...
    embedded_songs_playlists = songs_embeddings_model.get_songs_playlists_embeddings(
        tokenized_songs, songs_embeddings_model.model, pool_method
    )
    if verbose:
        print("2. Generating titles embeddings...")
    embedded_titles_playlists = title_embeddings_model.get_titles_embeddings(
    ...
    playlist_embeddings = normalize_embeddings(playlist_embeddings)
    if save:
